...
const Inicio = () => {
    ...
    <Informacion >
        <ContainerTarjetas>
            <TarjetasInformativas><h3>VISTA GRAFICA</h3><ContenedorImagen style={{backgroundImage: `url(${graficas})`}}>
            </ContenedorImagen> 
            ...
            <TarjetasInformativas><h3>SEGURIDAD</h3><ContenedorImagen style={{backgroundImage: `url(${seguridad})`}}></ContenedorImagen> 
                <p style={{marginLeft:"1em", marginRight:"1em", marginBottom:"9em"}}> 
                    <p>
            ...
            <TarjetasInformativas><h3>HERRAMIENTAS</h3><ContenedorImagen style={{backgroundImage: `url(${herramientas})`}}></ContenedorImagen>
            <p style={{marginLeft:"1em", marginRight:"1em"}}> 
                <p>
